...
struct R: Rswift.Validatable {
  ...
  struct file {
    /// Resource file `charactersList.json`.
    static let charactersListJson = Rswift.FileResource(bundle: R.hostingBundle, name: "charactersList", pathExtension: "json")

    /// `bundle.url(forResource: "charactersList", withExtension: "json")`
    static func charactersListJson(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.charactersListJson
  ...
  struct nib {
    ...
    @available(*, deprecated, message: "Use UINib(resource: R.nib.characterListTableViewCell) instead")
    static func characterListTableViewCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.characterListTableViewCell)
    }
    #endif
...
struct _R: Rswift.Validatable {
  ...
  struct nib {
    ...
    struct _CharacterListTableViewCell: Rswift.NibResourceType, Rswift.ReuseIdentifierType {
      ...
      let bundle = R.hostingBundle
      let identifier = "CharacterListTableViewCell"
      let name = "CharacterListTableViewCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> CharacterListTableViewCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? CharacterListTableViewCell
      }
